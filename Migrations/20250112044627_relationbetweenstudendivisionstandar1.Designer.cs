...
namespace JWTAuthCoreAPIRestful.Migrations
{
    ...
    [Migration("20250112044627_relationbetweenstudendivisionstandar1")]
    partial class relationbetweenstudendivisionstandar1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JWTAuthCoreAPIRestful.Models.StudentResultModel.Student", b =>
                {
                    b.HasOne("JWTAuthCoreAPIRestful.Models.StudentResultModel.Division", null)
                        .WithOne()
                        .HasForeignKey("JWTAuthCoreAPIRestful.Models.StudentResultModel.Student", "DivisionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JWTAuthCoreAPIRestful.Models.StudentResultModel.Standard", null)
                        .WithOne()
                        .HasForeignKey("JWTAuthCoreAPIRestful.Models.StudentResultModel.Student", "StandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
